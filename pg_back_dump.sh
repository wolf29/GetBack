...
# Postgresql database back-up and file maintenance DC4 - this is a    ##
...
# from the directory in which the script resides -- '/var/lib/pgsql'  ##
# The above folder is the 'home folder' for the postgres user         ##
#                                                                     ##
# On DC4 the way to become the postgres user in the simplest possible ##
...
# returning the full path to that location. '/var/lib/pgsql'          ##
#                                                                     ##
# The 'ls -l' command will show you the contents of the folder.       ##
#                                                                     ##
# (c)2011 -  Wolf Halton, Lyrasis                               ########
...
##  As postgres user...
pg_dumpall > dc4_pg_dumpall.sql
# makes a data-dump

tar czf DC4_pg_dumpall_`date '+%F_%H_%M'`.tar.gz dc4_pg_dumpall.sql		
# Copies the compressed data-dump to the backups prep folder

find /var/lib/pgsql/DC4_pg_dumpall* -mtime +7 -exec rm {} \;
